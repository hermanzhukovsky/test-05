...
function scrollToSection(e) {
	...
	let href = e.target.closest('a').getAttribute('href').substring(1);
	const scrollTarget = document.getElementById(href);
	
	let topOffset = document.querySelector('.header__body').offsetHeight + 10;
	
	if (!document.querySelector('header').classList.contains('_scroll')) {
